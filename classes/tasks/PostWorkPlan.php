		...
		if ($eteamMiscProjectMessages) {
			...
			foreach ($messages as $messageId => $messageDetails) {
				...
				if (
					...
					GoogleAI::setPrompt("Please provide a random inspirational quote. The inspirational should boost the morale of our team. Quote can either be generated by you or famous one by someone mentioning their name.");
