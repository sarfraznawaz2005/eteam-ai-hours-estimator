		...
		if ($eteamMiscProjectMessages) {
			...
			foreach ($messages as $messageId => $messageDetails) {
				...
				if (
					...
					GoogleAI::setPrompt("Please provide a inspirational quote tailored to a software engineering company. This inspirational quote which can be on software engineering or web designing should boost the morale of our team. Quote can either be generated by you or famous quote by someone mentioning their name.");
