		...
		if ($eteamMiscProjectMessages) {
			...
			foreach ($messages as $messageId => $messageDetails) {
				...
				if (
                    ...
                    $aiModel::setPrompt("Please provide a random inspirational quote that boosts the morale of our team. The quote can be generated by you or be a famous one by someone, in which case you should mention their name.");
